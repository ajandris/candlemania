...
The main Entity is BlogPost written by a currently logged-in user (multiplicity of the link is zero to many - 
user may not have written any blogs).
BlogPost has zero or many comments (Entity: BlogComment) written by a currently logged-in user (multiplicity of 
links BlogPost - BlogComment and BlogComment - User are zero to many on both).
